...
@section('content')
<h2 class="content-heading">Deduction Module</h2>
<div class="row">
    <div class="col-md-4">
        <div class="block block-themed">
            <div class="block-header bg-earth">
                <h3 class="block-title">Create Deduction</h3>
            ...
            <div class="block-content">
                {!! Form::open(['method'=>'POST','action'=>'DeductionController@store']) !!}
    ...
    <div class="col-md-8">
        <div class="block block-themed">
            <div class="block-header bg-earth">
                <h3 class="block-title">Deduction List</h3>
            </div>
...
<div class="modal fade" id="edit{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-popout" aria-hidden="true">
    <div class="modal-dialog modal-dialog-popout" role="document">
        <div class="modal-content">
            {!! Form::open(['method'=>'PATCH','action'=>['DeductionController@update',$data->id]]) !!}
            <div class="block block-themed">
                <div class="block-header bg-earth">
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ action('DeductionController@index') }}",
        columns: [
            {data: 'name', name: 'name'},
